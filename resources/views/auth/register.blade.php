...
@section('content')
    <div class="h-full " style="background: url({{ URL::asset('assets/images/vento.webp') }}) fixed center/cover">
        <!-- Container -->
        <div class="mx-auto">
            <div class="flex justify-center px-6 py-12">
                ...
                <div class="w-full xl:w-3/4 lg:w-11/12 flex">
                    ...
                    <div class="w-full navbargradient dark:bg-gray-700 p-5  rounded-lg lg:rounded-l-none bg-neutral-700 opacity-95">
                        ...
                        <form action="{{ route('register') }}" method="POST"
                            ...
                            <div class="mb-6 text-center">
                                <button
                                    class="w-full px-4 py-2 font-bold text-blue-900 bg-neutral-600 rounded-full hover:bg-orange-100 dark:bg-blue-700 dark:text-white dark:hover:bg-blue-900 focus:outline-none focus:shadow-outline"
                                    type="submit">
                                    Register Account
                                </button>
                            </div>
