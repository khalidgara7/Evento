                    ...
                    <div class="container-xl wide-xl">
                        <div class="nk-content-body">
                            ...
                            <div class="nk-block">
                                ...
                                <div class="row g-3 filter-container filter-animation-off">
                                            ...
                                            <div class="card-inner">
                                                <div class="d-flex position-relative">
                                                    ...
                                                    <div class="ms-4 flex-grow-1">
                                                        ...
                                                        <p class="sub-text">Produce trendy blog ideas for your business
                                                            that engages.</p>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="card-inner">
                                                <div class="d-flex position-relative">
                                                    ...
                                                    <div class="ms-4 flex-grow-1">
                                                        ...
                                                        <p class="sub-text">Create lists and outlines for your articles
                                        ...
                                        <div class="card">
                                            <div class="card-inner">
                                                <div class="d-flex position-relative">
                                                    <div class="d-inline-flex position-absolute end-0 top-0">
                                                        <div
                                                            class="badge border-0 bg-pink text-white rounded-pill text-uppercase">
                                                            Popular</div>
                                                    </div>
                                                    <div class="user-avatar text-primary bg-primary-dim mb-3">
                                                    ...
                                                    <div class="ms-4 flex-grow-1">
                                                        ...
                                                        <p class="sub-text">Write blog articles in minutes with the
                                                            most advanced AI writing pilot.</p>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="card-inner">
                                                <div class="d-flex position-relative">
                                                    ...
                                                    <div class="ms-4 flex-grow-1">
                                                        ...
                                                        <p class="sub-text">Write the pros and cons of a product,
                                                            service or website for your blog article.</p>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="card-inner">
                                                <div class="d-flex position-relative">
                                                    ...
                                                    <div class="ms-4 flex-grow-1">
                                                        ...
                                                        <p class="sub-text">End your blog articles with an engaging
                                    ...
                                    <div class="col-12 filter-item social-media" data-category="social-media">
                                        <div class="card">
                                            <div class="card-inner">
                                                <div class="d-flex position-relative">
                                                    <div class="d-inline-flex position-absolute end-0 top-0">
                                                    ...
                                                    <div class="ms-4 flex-grow-1">
                                                        ...
                                                        <p class="sub-text">Creative and engaging social media post for
                                                            your brand.</p>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="card-inner">
                                                <div class="d-flex position-relative">
                                                    ...
                                                    <div class="ms-4 flex-grow-1">
                                                        ...
                                                        <p class="sub-text">Write catchy and convincing headlines to
                                                            make your Facebook Ads stand out.</p>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="card-inner">
                                                <div class="d-flex position-relative">
                                                    ...
                                                    <div class="ms-4 flex-grow-1">
                                                        ...
                                                        <p class="sub-text">Write a Google Ads description that stands
                                                            out and generates leads.</p>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="card-inner">
                                                <div class="d-flex position-relative">
                                                    ...
                                                    <div class="ms-4 flex-grow-1">
                                                        ...
                                                        <p class="sub-text">Generate SEO optimized tags/keywords for
                                                            your YouTube video.</p>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="card-inner">
                                                <div class="d-flex position-relative">
                                                    ...
                                                    <div class="ms-4 flex-grow-1">
                                                        ...
                                                        <p class="sub-text">Create content for your LinkedIn profile
                                                            that will help you to grow.</p>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-12 filter-item website-copy-seo" data-category="website-copy-seo">
                                        <div class="card">
                                            <div class="card-inner">
                                                <div class="d-flex position-relative">
                                                    ...
                                                    <div class="ms-4 flex-grow-1">
                                                        ...
                                                        <p class="sub-text">Generate professional copy for your website
                                                            that converts users.</p>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="card-inner">
                                                <div class="d-flex position-relative">
                                                    ...
                                                    <div class="ms-4 flex-grow-1">
                                                        ...
                                                        <p class="sub-text">Generate frequently asked questions based
                                                            on your product description.</p>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="card-inner">
                                                <div class="d-flex position-relative">
                                                    ...
                                                    <div class="ms-4 flex-grow-1">
                                                        ...
                                                        <p class="sub-text">Generate content that is unique to
                                                            represent about your business.</p>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="card-inner">
                                                <div class="d-flex position-relative">
                                                    ...
                                                    <div class="ms-4 flex-grow-1">
                                                        ...
                                                        <p class="sub-text">Add authentic social proof to your website
                                                            by generating user testimonials.</p>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
