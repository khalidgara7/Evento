                            ...
                            <div class="nk-block-head nk-block-head-sm">
                                <div class="nk-block-between g-3">
                                    <div class="nk-block-head-content">
                                        <h3 class="nk-block-title page-title">Drafts</h3>
                                        ...
                                        <div class="card-inner p-0">
                                            <div class="nk-tb-list nk-tb-tnx">
                                                ...
                                                <div class="nk-tb-item">
                                                    ...
                                                    <div class="nk-tb-col tb-col-sm">
                                                        <div class="badge badge-dim bg-dark rounded-pill">Document
                                                        </div>
                                                    </div>
                                                    <div class="nk-tb-col tb-col-md">
                                                ...
                                                <div class="nk-tb-item">
                                                    ...
                                                    <div class="nk-tb-col tb-col-sm">
                                                        <div class="badge badge-dim bg-primary rounded-pill">Blog
                                                            Content</div>
                                                    </div>
                                                    <div class="nk-tb-col tb-col-md">
                                                        <div class="sub-text d-inline-flex flex-wrap gx-2">
                                                ...
                                                <div class="nk-tb-item">
                                                    <div class="nk-tb-col">
                                                        <div class="caption-text">Exploring the Latest Breakthroughs
                                                            and Innovations</div>
                                                    </div>
                                                    <div class="nk-tb-col tb-col-sm">
                                                        <div class="badge badge-dim bg-warning rounded-pill">Facebook
                                                            Caption</div>
                                                    </div>
                                                    <div class="nk-tb-col tb-col-md">
                                                        <div class="sub-text d-inline-flex flex-wrap gx-2">
                                                ...
                                                <div class="nk-tb-item">
                                                    <div class="nk-tb-col">
                                                        <div class="caption-text">Revolutionizing Industries and
                                                            Changing Way of Transact</div>
                                                    </div>
                                                    <div class="nk-tb-col tb-col-sm">
                                                        <div class="badge badge-dim bg-secondary rounded-pill">Google
                                                            Ads</div>
                                                    </div>
                                                    <div class="nk-tb-col tb-col-md">
                                                        <div class="sub-text d-inline-flex flex-wrap gx-2">
                                                ...
                                                <div class="nk-tb-item">
                                                    <div class="nk-tb-col">
                                                        <div class="caption-text">Connecting Our World and Shaping the
                                                            Future of Smart Living</div>
                                                    </div>
                                                    <div class="nk-tb-col tb-col-sm">
                                                        <div class="badge badge-dim bg-danger rounded-pill">YouTube
                                                            Title</div>
                                                    </div>
                                                    <div class="nk-tb-col tb-col-md">
                                                        <div class="sub-text d-inline-flex flex-wrap gx-2">
                                                ...
                                                <div class="nk-tb-item">
                                                    <div class="nk-tb-col">
                                                        <div class="caption-text">Harnessing the Scalability and
                                                            Efficiency of the Cloud</div>
                                                    </div>
                                                    <div class="nk-tb-col tb-col-sm">
                                                        <div class="badge badge-dim bg-gray rounded-pill">Website Copy
                                                        </div>
                                                    </div>
                                                    <div class="nk-tb-col tb-col-md">
                                                        <div class="sub-text d-inline-flex flex-wrap gx-2">
                                                ...
                                                <div class="nk-tb-item">
                                                    <div class="nk-tb-col">
                                                        <div class="caption-text">Exploring the Latest Developments in
                                                            Electric Vehicles and Autonomous Cars</div>
                                                    </div>
                                                    <div class="nk-tb-col tb-col-sm">
                                                        <div class="badge badge-dim bg-primary rounded-pill">Blog
                                                            Content</div>
                                                ...
                                                <div class="nk-tb-item">
                                                    <div class="nk-tb-col">
                                                        <div class="caption-text">Protecting Data and Privacy in an
                                                            Ever-Changing Landscape</div>
                                                    </div>
                                                    <div class="nk-tb-col tb-col-sm">
                                                        <div class="badge badge-dim bg-success rounded-pill">Pros &amp;
                                                            Cons</div>
                                                    </div>
                                                    <div class="nk-tb-col tb-col-md">
                                                        <div class="sub-text d-inline-flex flex-wrap gx-2">
                                                ...
                                                <div class="nk-tb-item">
                                                    <div class="nk-tb-col">
                                                        <div class="caption-text">How Technology is Transforming
                                                            Industries and Redefining Job Roles</div>
                                                    </div>
                                                    <div class="nk-tb-col tb-col-sm">
                                                        <div class="badge badge-dim bg-primary rounded-pill">Blog
                                                            Conclusion</div>
