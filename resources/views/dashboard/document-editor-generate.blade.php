                                        ...
                                        <div class="nk-editor-base">
                                            ...
                                            <div class="tab-content mt-0">
                                                <div class="tab-pane fade show active" id="AIWriter">
                                                    <form action="document-editor-edit.html" class="px-3 py-3">
                                                        <div class="row gy-4 gx-4">
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <div class="form-control-wrap">
                                                                        <select class="form-select js-select2">
                                                                            <option value="1">Social Media Posts
                                                                            </option>
                                                                            <option value="2">Website Copy
                                                                            </option>
                                                                        </select>
                                                                    </div>
                                                                </div>
                                                            ...
                                                            <div class="col-12">
                                                                <div class="form-group">
                                                                    <label class="form-label">What do you want to
                                                                        generate?</label>
                                                                    <div class="form-control-wrap">
                                                                        <textarea cols="30" rows="4" class="form-control">Write a Facebook post about openai that revolutionizes the world through the power of data.</textarea>
                                                                    </div>
                                                                    <div
                                                                        class="form-note d-flex justify-content-end mb-n1">
                                                            ...
                                                            <div class="col-12">
                                                                <div class="form-group">
                                                                    <label for="PrimaryKeywords"
                                                                        class="form-label">Primary Keywords</label>
                                                                    <div class="form-control-wrap">
                                                                        <input id="PrimaryKeywords" type="text"
                                                                            class="form-control"
                                                                            value="chatgpt, openai, facebook" />
                                                                    </div>
                                                                    <div
                                                                        class="form-note d-flex justify-content-between">
                                                                        <span>Separated with a
                                                                            comma</span><span>0/10</span>
                                                                    </div>
                                                                </div>
                                                            </div><!-- .col -->
                                                            <div class="col-6">
                                                            ...
                                                            <div class="col-6">
                                                                <div
                                                                    class="form-group d-flex align-items-center flex-row-reverse">
                                                                    <label for="Variant"
                                                                        class="form-label ms-3 mb-0 flex-grow-1">Variant</label>
                                                                    <div class="form-control-wrap w-70px">
                                                                        <input id="Variant" type="number"
